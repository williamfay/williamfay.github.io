    ...
    return (
        <div className="about_container">
                ...
                <div class='row_1 child'>
                    ...
                    <h3 class="about-text-1">Fourteen countries and counting</h3>
                </div>
                <div class='row_2 child'>
                    <h1 class="about-sub-head-2">URBANIST</h1>
                    <h3 class="about-text-2">Trains, bikes, buildings, parks, busses, and much, much more</h3>
                </div>
                <div class='row_3 child'>
                    <h1 class="about-sub-head-3">EDUCATOR</h1>
                    <h3 class="about-text-3">From Thailand to Pennsylvania, educating the next generation and life-long learning is a passion</h3>
                </div>
                <div class='row_4 child'>
                    <h1 class="about-sub-head-4">CAT DAD</h1>
                    <h3 class="about-text-4">My two cats, Noodle and Tatum, bring joy to my life</h3>
                </div>
        </div>
    )
}